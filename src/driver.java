...
public class driver {
	...
	public static void main(String[] args) {
		...
		// a. Displaying all employee information
		System.out.println("\n\n::: a): All Employees Information :::\n\n");
		
		for(int i=0; i<9; i++)
			System.out.println(employees.get(i).toString());
			
		
		//b. Part time staff salaries
		System.out.println("\n\n::: b): Total Monthly Salary for all the part time staff :::\n\n");
		double total =0;
		
		for(int i=6; i<9; i++)
		{	
			total += employees.get(i).monthlyEarnings();
			System.out.println("Salary of part time employee "+ employees.get(i).getID()+" is :"+ employees.get(i).monthlyEarnings());
		}
		System.out.println("Total Salary for all part time employees: "+ total);
		
		
		//c. Total salary for all the employee
		System.out.println("\n\n::: c): Total Monthly Salary for all the part time staff :::\n\n");
		total =0;
		
		for(int i=0; i<9; i++)
		{	
			total += employees.get(i).monthlyEarnings();
			System.out.println("Salary of employee "+ employees.get(i).getID()+" is :"+ employees.get(i).monthlyEarnings());
		}
		System.out.println("Total Salary for all employees: "+ total);

		//d) Display all employee information descending by ID using interface Comparable
		...
		try {
			Faculty f = (Faculty) employees.get(3).clone();
			f.setFirstName("XYZ");
